...
export default interface FileSystemProvider extends Object {
	...
	getFileAttributeView(arg0: Path, arg1: Class, arg2: Array<LinkOption>): FileAttributeView;
	...
	newAsynchronousFileChannel(arg0: Path, arg1: Set, arg2: ExecutorService, arg3: Array<FileAttribute>): AsynchronousFileChannel;
	newByteChannel(arg0: Path, arg1: Set, arg2: Array<FileAttribute>): SeekableByteChannel;
	newDirectoryStream(arg0: Path, arg1: DirectoryStream$Filter): DirectoryStream;
	newFileChannel(arg0: Path, arg1: Set, arg2: Array<FileAttribute>): FileChannel;
	newFileSystem(arg0: any, arg1: Map): FileSystem;
	newFileSystem(arg0: Path, arg1: Map): FileSystem;
	newInputStream(arg0: Path, arg1: Array<OpenOption>): InputStream;
	newOutputStream(arg0: Path, arg1: Array<OpenOption>): OutputStream;
	readAttributes(arg0: Path, arg1: Class, arg2: Array<LinkOption>): BasicFileAttributes;
	readAttributes(arg0: Path, arg1: string, arg2: Array<LinkOption>): Map;
	readSymbolicLink(arg0: Path): Path;
	setAttribute(arg0: Path, arg1: string, arg2: Object, arg3: Array<LinkOption>): void;
}
...
export default class FileSystemProvider {
	...
	public static $isInstance(obj: any): obj is FileSystemProvider {
